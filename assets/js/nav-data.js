...
const HANDBOOK_CHAPTERS = [
  {
    ...
    items: [
      ...
      { title: "Laboratory Rules", file: "chapters/laboratory-rules.html",       status: "draft" },
      { title: "Safety",         file: "chapters/laboratory-safety.html",       status: "draft" }
    ]
  },
  {
    category: "Equipment",
    items: [
      ...
      { title: "Analytical HPLC",         file: "chapters/equipment-analytical-hplc.html",   status: "draft" },
      ...
      { title: "LCMS",                    file: "chapters/equipment-lcms.html",              status: "draft" },
